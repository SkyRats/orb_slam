...
class Scale(object): # visual odometry drone controler
    ...
    def __init__(self):
        ...
        config_path = rospy.get_param('~config_path',str(rospack.get_path('orb_slam')+'/config/maps/recorded_maps.json'))
